    ...
    public function __construct(){
        ...
        if ($this->errors) {
            ...
            try {
                ...
                $mail->SMTPAuth = true;
                $mail->Username = 'hello@xn--80aakbe8ailapli8ch5fi9c.xn--p1ai';
                $mail->Password = '209389zkj';
                $mail->SMTPSecure = 'ssl';
                $mail->Port = 465;
                $mail->CharSet = 'UTF-8';

                //Recipients
                $mail->setFrom('hello@xn--80aakbe8ailapli8ch5fi9c.xn--p1ai', 'ДСП');
                $mail->addAddress('hello@xn--80aakbe8ailapli8ch5fi9c.xn--p1ai', 'ДСП');
                $mail->addReplyTo('hello@xn--80aakbe8ailapli8ch5fi9c.xn--p1ai', 'ДСП');
